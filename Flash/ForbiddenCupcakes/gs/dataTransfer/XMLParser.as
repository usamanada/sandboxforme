class gs.dataTransfer.XMLParser
{
    ...
    function parseLoadedXML(success_boolean)
    {
        ...
        var _loc8 = _xml;
        var _loc2 = _loc8.firstChild.firstChild;
        var _loc7 = _loc8.firstChild.lastChild;
        _loc8.firstChild.obj = _results_obj;
        while (_loc2 != undefined)
        {
            if (_loc2.nodeName == null && _loc2.nodeType == 3)
            {
                _loc2.parentNode.obj.value = this.searchAndReplace(_loc2.nodeValue, "\r\n", "");
            }
            else
            {
                var _loc4 = {};
                ...
                {
                    _loc4[_loc6] = _loc2.attributes[_loc6];
                } // end of for...in
                var _loc5 = _loc2.parentNode.obj;
                if (_loc5[_loc2.nodeName] == undefined)
                {
                    _loc5[_loc2.nodeName] = [];
                } // end if
                _loc2.obj = _loc4;
                _loc5[_loc2.nodeName].push(_loc4);
            } // end else if
            if (_loc2.childNodes.length > 0)
            {
                _loc2 = _loc2.childNodes[0];
                continue;
            } // end if
            for (var _loc3 = _loc2; _loc3.nextSibling == undefined && _loc3.parentNode != undefined; _loc3 = _loc3.parentNode)
            {
            } // end of for
            _loc2 = _loc3.nextSibling;
            if (_loc3 == _loc7)
            {
                _loc2 = undefined;
            } // end if
        } // end while
        this._onComplete_func(true, _results_obj, _loc8);
    } // End of the function
