...
namespace BizTalkSetUp
{
    class Helper
    {
        ...
        public static Dictionary<string, Party> GetParties()
        {
            ...
            {
                BizTalkSetUp.Party bp = new BizTalkSetUp.Party();
                ...
                {
                    BizTalkSetUp.PartyAlias bpa = new PartyAlias();
                ...
                {
                    BizTalkSetUp.PartySendPortRef bps = new PartySendPortRef();
                    bps.Name = sp.Name;
        ...
        public static void HostRemove(Host host)
        {
            if (host == null)
                return;
            WMIMethods.HostInstanceStop(host.HostInstances[host.Name]);
